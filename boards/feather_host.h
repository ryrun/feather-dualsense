...
// Feather RP2040 USB Host A board wiring for PIO-USB host.
#define FEATHER_HOST_USB_DP_PIN 16
#define FEATHER_HOST_USB_DM_PIN 17
#define FEATHER_HOST_VBUS_EN_PIN 18
